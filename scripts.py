...
def birthdayCakeCandles(candles):
    # Write your code here
    candle_list = sorted(list(candles))
    return candle_list.count(candle_list[-1])
...
def insertionSort1(n, arr):
    ...
    while value < arr[cur_index_value-1]:
        arr.pop(cur_index_value)
        arr.insert(cur_index_value-1, arr[cur_index_value-1])
        cur_index_value = cur_index_value -1
        print(*arr)
    print(*arr[0:cur_index_value],value,*arr[cur_index_value+1:])
